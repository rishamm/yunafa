...
const galleryItemsData: GalleryItem[] = [
   ...
   },
  {
   ...
   { id: 7, type: 'box1',
    imageUrl: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzN8fGZhc2hpb258ZW58MHx8MHx8fDA%3D%3D',
    ...
    id: 8,
    type: 'box2',
    imageUrl: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDJ8fGZhc2hpb258ZW58MHx8MHx8fDA%3D%3D',
      ...
      >
        {galleryItemsData.map((item) => (
          <div
            key={item.id}
            className={cn(
              'w-full h-[360px]', // Height of each box
              'transform-preserve-3d',
              item.type === 'box1' ?
                'bg-gradient-to-r from-white from-70% to-[#b9b0b0] [transform:translateX(-50%)_rotateY(65deg)] [transform-origin:right_center]' :
                'bg-gradient-to-l from-white from-70% to-[#b9b0b0] [transform:translateX(50%)_rotateY(-65deg)] [transform-origin:left_center]'
            )}
          >
            {item.imageUrl && (
              <div className="relative w-full h-full">
                <Image
                  ...
                  fill
                  className="object-cover -rotate-90" // Added -rotate-90
