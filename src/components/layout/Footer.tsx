    ...
    <footer className="bg-card border-t border-primary mt-auto overflow-hidden">
      <div className="h-full flex flex-col gap-0 justify-center pt-8 pb-0">
        ...
        <div className="text-center h-full"> {/* This div will center the large YUNAFA text */}
          <span className="font-['Cormorant_SC',_serif] uppercase text-primary tracking-[-0.02em] leading-[0.7em] whitespace-nowrap text-[24vw] relative inline-flex items-start justify-center">
            YUNAFA
            {/* Positioned at the very top right of the text block */}
            <span className="absolute top-0 -right-[0.25em] text-[0.12em] font-sans leading-none transform -translate-y-[20%]">
              &reg;
            </span>
          </span>
        </div>
